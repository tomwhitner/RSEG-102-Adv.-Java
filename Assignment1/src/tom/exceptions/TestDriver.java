...
public class TestDriver {
	...
	public static void main(String[] args) {
		...
		for (BigDecimal wage : testWages) {
			try {
				System.out.println("Validating wage: " + CURRENCY_FORMAT.format(wage));				
				verifyEmployeeWage(wage);
				System.out.println(" Wage is valid.");
			} catch (IllegalWageException e) {
				System.out.println(" Wage " + CURRENCY_FORMAT.format(e.getWage()) + " is illegal.  Cannot be negative or zero.");
			} catch (MinWageException e) {
				System.out.println(" Wage " + CURRENCY_FORMAT.format(e.getWage()) + " is out of range.  Must be greater than or equal to " + CURRENCY_FORMAT.format(e.getWageLimit()));
			} catch (MaxWageException e) {
				System.out.println(" Wage " + CURRENCY_FORMAT.format(e.getWage()) + " is out of range.  Must be less than or equal to " + CURRENCY_FORMAT.format(e.getWageLimit()));
			} finally {
